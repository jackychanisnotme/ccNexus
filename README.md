...
[![许可证: 非商业源码可见](https://img.shields.io/badge/License-Non--Commercial%20Source%20Available-orange.svg)](LICENSE)
...
>
> 授权说明：上游 `lich0821/ccNexus` 的原始代码继续保留 MIT License；本 fork 之后新增和修改的 ccNexus Optimized 代码、构建、文档、UI 与品牌素材采用非商业源码可见授权。Release 二进制可免费用于个人非商业场景，商业使用需取得单独书面授权。
...
- 上游 `lich0821/ccNexus` 原始代码：继续保留 MIT License，详见 [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md)。
- 本 fork 之后的新增和修改内容：采用 [ccNexus Optimized Non-Commercial Source Available License](LICENSE)。
- Release 二进制：免费提供给个人非商业使用。
- 商业使用、公司内部业务使用、SaaS/托管服务、转售、打包分发或白标使用：必须先取得单独商业授权，详见 [COMMERCIAL_LICENSE.md](COMMERCIAL_LICENSE.md)。

`ccNexus`、`ccNexus Optimized`、项目 Logo、图标和相关品牌素材保留权利，未经授权不得用于商业宣传、混淆来源或暗示官方背书。
