export default {
    ...
    session: {
        ...
        codexRepairSelectedSession: 'Selected session',
        codexRepairSelectedDesc: 'Repair only the selected session: {name}',
        codexRepairSelectedUnavailable: 'No Codex session is selected yet.',
