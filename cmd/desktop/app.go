...
func (a *App) AddEndpoint(name, apiUrl, apiKey, authMode, transformer, model, thinking, proxyURL string, forceStream bool, codexFastMode bool, maxConcurrentRequests int, remark string) error {
	return a.endpoint.AddEndpoint(name, apiUrl, apiKey, authMode, transformer, model, thinking, proxyURL, forceStream, codexFastMode, maxConcurrentRequests, remark)
}
func (a *App) RemoveEndpoint(index int) error { return a.endpoint.RemoveEndpoint(index) }
func (a *App) UpdateEndpoint(index int, name, apiUrl, apiKey, authMode, transformer, model, thinking, proxyURL string, forceStream bool, codexFastMode bool, maxConcurrentRequests int, remark string) error {
	return a.endpoint.UpdateEndpoint(index, name, apiUrl, apiKey, authMode, transformer, model, thinking, proxyURL, forceStream, codexFastMode, maxConcurrentRequests, remark)
}
...
func (a *App) AddDiscoveredLANEndpoint(candidateJSON string) string {
	...
	if err := a.endpoint.AddEndpoint(newEndpoint.Name, newEndpoint.APIUrl, newEndpoint.APIKey, newEndpoint.AuthMode, newEndpoint.Transformer, newEndpoint.Model, newEndpoint.Thinking, newEndpoint.ProxyURL, newEndpoint.ForceStream, newEndpoint.CodexFastMode, newEndpoint.MaxConcurrentRequests, newEndpoint.Remark); err != nil {
		return desktopErrorJSON(err)
	}
